                                    ...
                                    <div class="row">
                                        <div class="col-md-7">
                                            <div class="checkout-method__login">
                                                 {!! Form::open(['url'=>'customer/login/check/user/','method'=>'POST']) !!}
                                                  
                                                 
                                                 <h5 class="checkout-method__title">{{Session::get('exception')}}</h5>
                                                 <?php 
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-input">
                                                    <input  type="text"  name="email" placeholder="Email" 
                                                            onblur="ajax_email_check(this.value, 'res');" id="email"   required="">
                                                </div>
                                            </div>
