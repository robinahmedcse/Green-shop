...
<?php 
    ...
    if($main_category_name =='Men' ||$main_category_name =='men' ||$main_category_name =='MEN'){
    
        $banner_peoduct=DB::table('tbl_men_pro')
                ->where('publication_status', 1)
                ->first();
        
 
         $ban_image =$banner_peoduct->man_pro_image_url;
...
<div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url({{asset($ban_image)}}) no-repeat scroll center center / cover ;">
   ...
   <?php  }elseif ($main_category_name =='Women' ||$main_category_name =='women' ||$main_category_name =='WOMEN') {
     
                $banner_peoduct=DB::table('tbl_women_pro')
                ->where('publication_status', 1)
                ->first();
        
 

         $ban_image =$banner_peoduct->woman_pro_image_url;
                    ...
                    <div class="row">
                        <div class="shop__grid__view__wrap">
                            <div role="tabpanel" id="grid-view" class="single-grid-view tab-pane fade in active clearfix">
                                ...
                                @foreach($published_mini_category_product as $product)
...
?>
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                                    <div class="category">
                                        <div class="ht__cat__thumb">
                                            <a href="{{URL::to($xx.'/product-details/'.$product->product_id)}}">
                                        ...
                                        <div class="fr__product__inner">
                                            <h4><a href="{{URL::to($xx.'/product-details/'.$product->product_id)}}">{{$product->product_name}}</a></h4>
                ...
                <div class="row">
                    <div class="col-xs-12">
                          ...
                          {{ $published_mini_category_product->links() }}
                ...
                <div class="htc__product__leftsidebar">
                    ...
                    <div class="htc__category">
                        ...
                        <ul class="ht__cat__list">
                             @foreach($miniPublishedCategory as $category)
                            <li><a href="{{URL::to('/products/'.$category ->mini_category_name.'/'.$category ->mini_category_id)}}">{{$category ->mini_category_name}}</a></li>
