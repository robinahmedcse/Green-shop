...
<div class='row '>
    <div class="">
        <h2 class="tex text-center text-success">Add Banner</h2>
    </div> 
    <div class="">
...
<!--        <form action="" method="POST"id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
             {!! Form::open(['url'=>'/wp-admin/master/banner/save','method'=>'POST','class'=>'form-horizontal form-label-left','enctype'=>'multipart/form-data']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    ...
                    <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="banner-image">Product Image<span class="required">*</span>
                 </label>
                 <div class="col-md-6 col-sm-6 col-xs-12">
