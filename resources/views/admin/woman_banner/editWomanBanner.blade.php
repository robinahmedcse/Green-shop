...
<div class='row '>
    <div class="">
        <h2 class="tex text-center text-success">Update Woman Banner</h2>
    </div> 
    <div class="">
...
<!--        <form action="" method="POST"id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
             {!! Form::open(['url'=>'/wp-admin/master/banner/woman/update/','method'=>'POST','name'=>'editForm','class'=>'form-horizontal form-label-left','enctype'=>'multipart/form-data']) !!}
            <!-- Category name -->
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" value="{{$banner_by_id->woman_pro_name}}"  name="banner_description" required class="form-control col-md-7 col-xs-12">
                    <input type="hidden" value="{{$banner_by_id->woman_pro_id}}" name="banner">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <img src="{{ asset($banner_by_id->woman_pro_image_url)}}" width="400px">
