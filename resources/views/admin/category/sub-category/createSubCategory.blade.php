...
<!--        <form action="" method="POST"id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
             {!! Form::open(['url'=>'/wp-admin/master/category/sub/store','method'=>'POST','class'=>'form-horizontal form-label-left']) !!}
            <!-- Category name -->
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <select name="category_id" class="form-control">
                        <option value="null">Select Main Category</option>
                             @foreach($all_published_main_category as $category)
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <select name="sub_category_publicationStatus" class="form-control">
