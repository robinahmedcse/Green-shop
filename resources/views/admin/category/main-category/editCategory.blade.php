...
<!--        <form action="" method="POST"id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
             {!! Form::open(['url'=>'/wp-admin/master/category/main/update','method'=>'POST','name'=>'editForm','class'=>'form-horizontal form-label-left']) !!}
            <!-- Category name -->
...
document.forms['editForm'].elements['publicationStatus'].value={{$category_by_id->category_publicationStatus}};
