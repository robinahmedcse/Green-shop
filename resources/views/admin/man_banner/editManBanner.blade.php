...
<!--        <form action="" method="POST"id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
             {!! Form::open(['url'=>'/wp-admin/master/banner/man/update/','method'=>'POST','name'=>'editForm','class'=>'form-horizontal form-label-left','enctype'=>'multipart/form-data']) !!}
            <!-- Category name -->
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" value="{{$banner_by_id->men_pro_name}}"  name="banner_description" required class="form-control col-md-7 col-xs-12">
                    <input type="hidden" value="{{$banner_by_id->men_pro_id}}" name="banner">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <img src="{{ asset($banner_by_id->man_pro_image_url)}}" width="400px">
